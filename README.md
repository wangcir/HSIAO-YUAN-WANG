...
* **專案概述**：
  ...
  * 針對過往紙本紀錄分散、易出錯的痛點，**首度為社團建立 Excel 表單電子化與自動化流程**，全面整合收支與庫存數據。
* **技術亮點**：
  * **建構** 整合式財務與庫存資料模型，將「存根聯紀錄」與「帳目明細」動態關聯，達成帳務即時自動更新。
  * **編寫** 自動化管理腳本，大幅減少手動核對帳目與人工清點講義的時間，**顯著降低人事與溝通成本**。
  * **設計** 直觀的電子化流水帳與預算追蹤看板，提升社團財務透明度，使前後任交接效率大幅提升。
